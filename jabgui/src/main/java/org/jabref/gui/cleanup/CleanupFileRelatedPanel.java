...
public class CleanupFileRelatedPanel extends VBox implements CleanupPanel {
    ...
    @FXML private CheckBox cleanupRenamePdfPreserveSuffix;
    ...
    private void bindProperties() {
        ...
        // Independent option: unlike the "only ..." modifiers, it is never disabled and does not depend on
        // "Rename files" being selected.
        cleanupRenamePdfPreserveSuffix.selectedProperty().bindBidirectional(viewModel.renamePdfPreserveSuffixSelected);
