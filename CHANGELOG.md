...
- We added a "Preserve suffix of modified files" option to the cleanup dialog, which keeps custom suffixes (such as `-fig6` in `key-fig6.jpg`) when renaming linked files instead of collapsing them onto the filename pattern. [#11358](https://github.com/JabRef/jabref/issues/11358)
